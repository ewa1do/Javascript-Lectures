...
// header.before(message); insert as siblings
...
// console.log(message.style.color); //does not work bc only shows inline styles
...
// console.log(h1.previuosSibling);
